...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Oct 10, 2025 00:00:00').getTime(),
...
const _slideSatu = function () {
  ...
  }, 8800);// durasi animasi teks "ketuk untuk melanjutkan" //
};
...
const _slideDua = function () {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      slideSatu.classList.add('d-none');// halaman happy birthday to you //
    }, 1000);// durasi animasi berpindah halaman //
  }, 1000);// durasi animasi berpindah ke ucapan teks //
  ...
  setTimeout(function () {
    ...
    document.body.addEventListener('click', function () {
      ...
      setTimeout(function () {
        slideDua.remove();
        _slideTiga();// halaman teks ucapan pertama //
      }, 1000);// durasi animasi berpindah halaman //
    })
  }, 25000);// durasi muncul teks "ketuk untuk melanjutkan" //
};
...
const _slideTiga = function () {
  ...
  setTimeout(function () {
    ...
    document.body.addEventListener('click', function () {
      ...
      slideTiga.classList.replace('animate__fadeInLeft', 'animate__fadeOut');
      tap.remove();
      setTimeout(function () {
        slideTiga.remove();
        _slideEmpat();// halaman teks ucapan kedua //
      }, 1000);// durasi animasi berpindah halaman //
    })
  }, 20000);// durasi muncul teks "ketuk untuk melanjutkan" //
}
...
new TypeIt("#teks1", {
  strings: ["Hari ini, saya langitkan semua doa terbaik saya untuk kamu.", "Semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh.",
  "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada.", "Semoga hari-hari kamu selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan."],
  startDelay: 4000,
  speed: 45,
